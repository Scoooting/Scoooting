    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            if (jwtService.validate(token)) {
                ...
                String username = jwtService.getClaims(token, "username", String.class);
                String email = jwtService.getSubject(token);
                String role = jwtService.getClaims(token, "role", String.class);
                Long userId = jwtService.getClaims(token, "userId", Long.class);
                ...
                log.error("UserService JwtAuthenticationFilter: Token validation FAILED");
            }
